                     ...
                     <ul class="list">
                        ...
                        <%
                        	...
                        	if(name==null)
                        		...
                        		out.print("<a href=index.jsp class=\"active\">登        陆</a>");
                        	else
                        		out.print("<a href=home.jsp class=\"active\">首        页</a>");
                         %>
                        </li>
                     ...
                     <div class="border-right">
                        <div class="xcontent">
                           <div class="inner">
                              ...
                              <div class="container">
                                 <div class="col-1">
                                    <h3>Information<img src="images/twitter.gif" alt="" /></h3>
                                    <div>
									 <form action="" id="contacts-form" class="wrapper">
                                 <fieldset class="field1">
                                 <div>
                                    <label>用户名：<%=session.getAttribute("userName") %></label>    
                                    <label>权&nbsp;&nbsp;&nbsp;限：<%=session.getAttribute("identity") %></label>
                                    <label>性&nbsp;&nbsp;&nbsp;别：<%=session.getAttribute("sex") %></label>
                                    <label>邮&nbsp;&nbsp;&nbsp;箱：<%=session.getAttribute("email") %></label>                                 
                                 </div>
                                 </fieldset>
                                 <fieldset class="field2">  
                                 <br/>
                                 <div class="link1" id="subLink"><a onclick="logout()"><em><b>退出</b></em></a></div>
                                 </fieldset>
                              </form>
									</div>
                                 </div>
...
<script type="text/javascript" language="javascript">
   function getResult(){
 	...
 	function logout(){	
		...
		http_request.open("POST","LogoutServlet",true);
