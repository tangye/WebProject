                        ...
                        <li><a href="gallery.jsp">海报观赏</a></li>
                         <%
                        	...
                        	if(name!=null && (identity.equals("管理员")  || identity .equals("社团") ))            
                        		out.print("<li><a href=publish.jsp class=\"active\">活动发布</a></li>");
                         %>
                     </ul>
                  </div>
                  <div class="left-bot-corner">
                  ...
                  <div class="border-left">
                     <div class="border-right">
                        <div class="xcontent">
                           <div class="inner">
                              <h3>Publish</h3>
                              <h4>请填写相关信息，我们将会在一星期内审核并上传活动页面</h4>
                             
                              <form action=""  >
                             	 <fieldset class="field1">
                                 <div>
                                    <label>活动标题：</label>
                                    <input type="text" name="actitle" class="publishText"/>
                                 </div>
                                 <div>
                                    <br/><label>活动页面URL：</label>
                                    <input type="text" name="acURL"  class="publishText"/>
                                 </div>
                                 </fieldset>                          
                                 <fieldset class="field2">   
                                 <div class="link1" id="subLink"><a onclick="publish(actitle,acURL)"><em><b>发布活动</b></em></a></div>
                                 </fieldset>
                             </form>>
...
<script type="text/javascript" language="javascript">
	...
	function publish(actitle,acURL){
		if(actitle.value==""){
			alert("活动标题不能为空");
    		return;
		}
    	...
    	createRequest("AddActivityServlet","title="+actitle.value+"&url="+acURL.value);
	}
